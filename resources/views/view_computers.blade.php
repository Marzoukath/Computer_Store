...
<body id="page-top">
    ...
    <img src="{{ asset('storage/' . $computer->photo    ) }}" alt="Ordinateur">
        ...
        <div class="card-content">
            ...
            <p>Nombre de cœurs: {{ $computer->core }}</p>
            <p>RAM: {{ $computer->ram }} Go</p>
            <p>Type de stockage: {{ $computer->type_stockage }}</p>
            <p>Capacité de stockage: {{ $computer->capacite_stockage }} Go</p>
            <p>Taille de l'écran: {{ $computer->taille_ecran }}"</p>
            <p>Clavier: {{ $computer->clavier }}</p>
            <p>Carte graphique: {{ $computer->carte_graphique }}</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('computers.update', $computer->id) }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel">Modifier l'Ordinateur</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="marque" class="form-label">Marque</label>
                            <input type="text" class="form-control" id="marque" name="marque" value="{{ $computer->marque }}">
                        </div>
                        <div class="mb-3">
    ...
    <!-- Modal Supprimer -->
    <div class="modal fade" id="deleteModal-{{ $computer->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
