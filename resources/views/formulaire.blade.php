        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container">
                <div class="form-container">
                  <h2>Informations sur l'Ordinateur</h2>
                ...
                @endif
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="processeur" name="processeur" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="ram">Nombre de coeurs</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="type" name="type_stockage" required>
                    </div>
                      <div class="form-group">
                        <label for="capacite">Capacite stockage</label>
                        <input type="text" id="capacite" name="capacite_stockage" required>
                      </div>    

                      <div class="form-group">
                        <label for="ram">Taille de l'ecran</label>
                        <input type="text" id="type" name="taille_ecran" required>
                      </div>
                      <div class="form-group">
                        <label for="ram">Clavier</label>
                        <input type="text" id="clavier" name="clavier" required>
                      </div>
                      <div class="form-group">
                        <label for="ram">Carte graphique</label>
                        <input type="text" id="carte_graphique" name="carte_graphique" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="ecran_tactile" name="ecran_tactile" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="autonomie" name="autonomie" required>
                      </div>
